...
help() {
    echo "Usage: docker run -dti --link mysql:mysql -e AD_SERVER=value1 -e USER_SVC=value2 -e PASS_SVC=value3 -e API_DB=value4 -e MYSQL_HOST=value5 -e MYSQL_USER=value6 -e MYSQL_PASS=value7 -e MYSQL_DB=value8  image:tag" >&2
    echo
    ...
    echo "   API_DB              url for connecting api the updated user control "
